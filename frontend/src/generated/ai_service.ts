  ...
  fromJSON(object: any): SQLResponse {
    return {
      ...
      tokensUsed: isSet(object.tokensUsed)
        ...
        : 0,
      timeTaken: isSet(object.timeTaken)
        ? Duration.fromJSON(object.timeTaken)
        : isSet(object.time_taken)
        ? Duration.fromJSON(object.time_taken)
        : undefined,
...
export const ProviderHealth: MessageFns<ProviderHealth> = {
  ...
  fromJSON(object: any): ProviderHealth {
    return {
      ...
      lastChecked: isSet(object.lastChecked)
        ? fromJsonTimestamp(object.lastChecked)
        : isSet(object.last_checked)
        ? fromJsonTimestamp(object.last_checked)
        : undefined,
      responseTime: isSet(object.responseTime)
        ? Duration.fromJSON(object.responseTime)
        : isSet(object.response_time)
        ? Duration.fromJSON(object.response_time)
        : undefined,
    };
  },
  ...
  fromJSON(object: any): Usage {
    return {
      ...
      requestCount: isSet(object.requestCount)
        ...
        ? Long.fromValue(object.request_count)
        : Long.ZERO,
      tokensUsed: isSet(object.tokensUsed)
        ? Long.fromValue(object.tokensUsed)
        : isSet(object.tokens_used)
        ? Long.fromValue(object.tokens_used)
        : Long.ZERO,
      successRate: isSet(object.successRate)
        ...
        : 0,
      avgResponseTime: isSet(object.avgResponseTime)
        ? Duration.fromJSON(object.avgResponseTime)
        : isSet(object.avg_response_time)
        ? Duration.fromJSON(object.avg_response_time)
        : undefined,
      lastUsed: isSet(object.lastUsed)
        ? fromJsonTimestamp(object.lastUsed)
        : isSet(object.last_used)
        ? fromJsonTimestamp(object.last_used)
        : undefined,
    };
  },
...
export const TestProviderRequest: MessageFns<TestProviderRequest> = {
  ...
  fromJSON(object: any): TestProviderRequest {
    return {
      provider: isSet(object.provider) ? providerFromJSON(object.provider) : Provider.PROVIDER_UNSPECIFIED,
      openaiConfig: isSet(object.openaiConfig)
        ? OpenAIConfig.fromJSON(object.openaiConfig)
        : isSet(object.openai_config)
        ? OpenAIConfig.fromJSON(object.openai_config)
        : undefined,
      anthropicConfig: isSet(object.anthropicConfig)
        ? AnthropicConfig.fromJSON(object.anthropicConfig)
        : isSet(object.anthropic_config)
        ? AnthropicConfig.fromJSON(object.anthropic_config)
        : undefined,
      ollamaConfig: isSet(object.ollamaConfig)
        ? OllamaConfig.fromJSON(object.ollamaConfig)
        : isSet(object.ollama_config)
        ? OllamaConfig.fromJSON(object.ollama_config)
        : undefined,
      huggingfaceConfig: isSet(object.huggingfaceConfig)
        ? HuggingFaceConfig.fromJSON(object.huggingfaceConfig)
        : isSet(object.huggingface_config)
        ? HuggingFaceConfig.fromJSON(object.huggingface_config)
        : undefined,
      claudecodeConfig: isSet(object.claudecodeConfig)
        ? ClaudeCodeConfig.fromJSON(object.claudecodeConfig)
        : isSet(object.claudecode_config)
        ? ClaudeCodeConfig.fromJSON(object.claudecode_config)
        : undefined,
      codexConfig: isSet(object.codexConfig)
        ? CodexConfig.fromJSON(object.codexConfig)
        : isSet(object.codex_config)
        ? CodexConfig.fromJSON(object.codex_config)
        : undefined,
    };
  },
...
export const GetUsageStatsResponse: MessageFns<GetUsageStatsResponse> = {
  encode(message: GetUsageStatsResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.usageStats).forEach(([key, value]: [string, Usage]) => {
  ...
  fromJSON(object: any): GetUsageStatsResponse {
    return {
      usageStats: isObject(object.usageStats)
        ? (globalThis.Object.entries(object.usageStats) as [string, any][]).reduce(
          (acc: { [key: string]: Usage }, [key, value]: [string, any]) => {
            acc[key] = Usage.fromJSON(value);
            return acc;
          },
          {},
        )
        : isObject(object.usage_stats)
        ? (globalThis.Object.entries(object.usage_stats) as [string, any][]).reduce(
          (acc: { [key: string]: Usage }, [key, value]: [string, any]) => {
            acc[key] = Usage.fromJSON(value);
            return acc;
          },
  ...
  toJSON(message: GetUsageStatsResponse): unknown {
    ...
    if (message.usageStats) {
      const entries = globalThis.Object.entries(message.usageStats) as [string, Usage][];
      if (entries.length > 0) {
        obj.usageStats = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial(object: DeepPartial<GetUsageStatsResponse>): GetUsageStatsResponse {
    const message = createBaseGetUsageStatsResponse();
    message.usageStats = (globalThis.Object.entries(object.usageStats ?? {}) as [string, Usage][]).reduce(
      (acc: { [key: string]: Usage }, [key, value]: [string, Usage]) => {
        if (value !== undefined) {
  ...
  fromJSON(object: any): AIConfig {
    return {
      defaultProvider: isSet(object.defaultProvider)
        ...
        : isSet(object.default_provider)
        ? providerFromJSON(object.default_provider)
      ...
      requestTimeout: isSet(object.requestTimeout)
        ? Duration.fromJSON(object.requestTimeout)
        : isSet(object.request_timeout)
        ? Duration.fromJSON(object.request_timeout)
        : undefined,
      rateLimitPerMin: isSet(object.rateLimitPerMin)
        ? globalThis.Number(object.rateLimitPerMin)
        : isSet(object.rate_limit_per_min)
        ? globalThis.Number(object.rate_limit_per_min)
        : 0,
...
export const OllamaConfig: MessageFns<OllamaConfig> = {
  ...
  fromJSON(object: any): OllamaConfig {
    return {
      ...
      models: globalThis.Array.isArray(object?.models) ? object.models.map((e: any) => globalThis.String(e)) : [],
      pullTimeout: isSet(object.pullTimeout)
        ? Duration.fromJSON(object.pullTimeout)
        : isSet(object.pull_timeout)
        ? Duration.fromJSON(object.pull_timeout)
        : undefined,
      generateTimeout: isSet(object.generateTimeout)
        ? Duration.fromJSON(object.generateTimeout)
        : isSet(object.generate_timeout)
        ? Duration.fromJSON(object.generate_timeout)
        : undefined,
      autoPullModels: isSet(object.autoPullModels)
        ? globalThis.Boolean(object.autoPullModels)
        : isSet(object.auto_pull_models)
        ? globalThis.Boolean(object.auto_pull_models)
        : false,
      configured: isSet(object.configured) ? globalThis.Boolean(object.configured) : false,
    };
  },
  ...
  fromJSON(object: any): HuggingFaceConfig {
    return {
      ...
      autoPullModels: isSet(object.autoPullModels)
        ...
        ? globalThis.Boolean(object.auto_pull_models)
        : false,
      recommendedModel: isSet(object.recommendedModel)
        ? globalThis.String(object.recommendedModel)
        : isSet(object.recommended_model)
        ? globalThis.String(object.recommended_model)
        : "",
      configured: isSet(object.configured) ? globalThis.Boolean(object.configured) : false,
    };
  },
