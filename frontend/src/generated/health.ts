  ...
  fromJSON(object: any): SystemMetrics {
    return {
      ...
      memoryTotalBytes: isSet(object.memoryTotalBytes)
        ...
        ? Long.fromValue(object.memory_total_bytes)
        : Long.ZERO,
      diskUsedBytes: isSet(object.diskUsedBytes)
        ? Long.fromValue(object.diskUsedBytes)
        : isSet(object.disk_used_bytes)
        ? Long.fromValue(object.disk_used_bytes)
        : Long.ZERO,
      diskTotalBytes: isSet(object.diskTotalBytes)
        ? Long.fromValue(object.diskTotalBytes)
        : isSet(object.disk_total_bytes)
        ? Long.fromValue(object.disk_total_bytes)
        : Long.ZERO,
      networkInBytes: isSet(object.networkInBytes)
        ? Long.fromValue(object.networkInBytes)
        : isSet(object.network_in_bytes)
        ? Long.fromValue(object.network_in_bytes)
        : Long.ZERO,
      networkOutBytes: isSet(object.networkOutBytes)
        ? Long.fromValue(object.networkOutBytes)
        : isSet(object.network_out_bytes)
        ? Long.fromValue(object.network_out_bytes)
        : Long.ZERO,
      goroutines: isSet(object.goroutines) ? globalThis.Number(object.goroutines) : 0,
      heapAllocBytes: isSet(object.heapAllocBytes)
        ? Long.fromValue(object.heapAllocBytes)
        : isSet(object.heap_alloc_bytes)
        ? Long.fromValue(object.heap_alloc_bytes)
        : Long.ZERO,
      heapSysBytes: isSet(object.heapSysBytes)
        ? Long.fromValue(object.heapSysBytes)
        : isSet(object.heap_sys_bytes)
        ? Long.fromValue(object.heap_sys_bytes)
        : Long.ZERO,
      loadAverage1m: isSet(object.loadAverage1m)
        ? globalThis.Number(object.loadAverage1m)
        : isSet(object.load_average_1m)
        ? globalThis.Number(object.load_average_1m)
        : 0,
      loadAverage5m: isSet(object.loadAverage5m)
        ? globalThis.Number(object.loadAverage5m)
        : isSet(object.load_average_5m)
        ? globalThis.Number(object.load_average_5m)
        : 0,
      loadAverage15m: isSet(object.loadAverage15m)
        ? globalThis.Number(object.loadAverage15m)
        : isSet(object.load_average_15m)
        ? globalThis.Number(object.load_average_15m)
        : 0,
    };
  },
  ...
  fromJSON(object: any): DatabaseMetrics {
    return {
      ...
      maxConnections: isSet(object.maxConnections)
        ...
        : 0,
      queriesExecuted: isSet(object.queriesExecuted)
        ? Long.fromValue(object.queriesExecuted)
        : isSet(object.queries_executed)
        ? Long.fromValue(object.queries_executed)
        : Long.ZERO,
      queriesFailed: isSet(object.queriesFailed)
        ? Long.fromValue(object.queriesFailed)
        : isSet(object.queries_failed)
        ? Long.fromValue(object.queries_failed)
        : Long.ZERO,
      avgQueryDurationMs: isSet(object.avgQueryDurationMs)
        ? globalThis.Number(object.avgQueryDurationMs)
        : isSet(object.avg_query_duration_ms)
        ? globalThis.Number(object.avg_query_duration_ms)
        : 0,
      bytesSent: isSet(object.bytesSent)
        ? Long.fromValue(object.bytesSent)
        : isSet(object.bytes_sent)
        ? Long.fromValue(object.bytes_sent)
        : Long.ZERO,
      bytesReceived: isSet(object.bytesReceived)
        ? Long.fromValue(object.bytesReceived)
        : isSet(object.bytes_received)
        ? Long.fromValue(object.bytes_received)
        : Long.ZERO,
      cacheHitRatio: isSet(object.cacheHitRatio)
        ? globalThis.Number(object.cacheHitRatio)
        : isSet(object.cache_hit_ratio)
        ? globalThis.Number(object.cache_hit_ratio)
        : 0,
      bufferCacheSizeBytes: isSet(object.bufferCacheSizeBytes)
        ? Long.fromValue(object.bufferCacheSizeBytes)
        : isSet(object.buffer_cache_size_bytes)
        ? Long.fromValue(object.buffer_cache_size_bytes)
        : Long.ZERO,
      databaseSizeBytes: isSet(object.databaseSizeBytes)
        ? Long.fromValue(object.databaseSizeBytes)
        : isSet(object.database_size_bytes)
        ? Long.fromValue(object.database_size_bytes)
        : Long.ZERO,
    };
  },
