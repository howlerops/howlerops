  ...
  fromJSON(object: any): QueryOptions {
    return {
      ...
      includeMetadata: isSet(object.includeMetadata)
        ...
        : false,
      fetchSize: isSet(object.fetchSize)
        ? globalThis.Number(object.fetchSize)
        : isSet(object.fetch_size)
        ? globalThis.Number(object.fetch_size)
        : 0,
    };
  },
  ...
  fromJSON(object: any): QueryResult {
    return {
      ...
      rowCount: isSet(object.rowCount)
        ...
        : Long.ZERO,
      moreResults: isSet(object.moreResults)
        ? globalThis.Boolean(object.moreResults)
        : isSet(object.more_results)
        ? globalThis.Boolean(object.more_results)
        : false,
  ...
  fromJSON(object: any): QueryStats {
    return {
      ...
      rowsAffected: isSet(object.rowsAffected)
        ...
        : Long.ZERO,
      rowsReturned: isSet(object.rowsReturned)
        ? Long.fromValue(object.rowsReturned)
        : isSet(object.rows_returned)
        ? Long.fromValue(object.rows_returned)
        : Long.ZERO,
      bytesProcessed: isSet(object.bytesProcessed)
        ? Long.fromValue(object.bytesProcessed)
        : isSet(object.bytes_processed)
        ? Long.fromValue(object.bytes_processed)
        : Long.ZERO,
      bytesReturned: isSet(object.bytesReturned)
        ? Long.fromValue(object.bytesReturned)
        : isSet(object.bytes_returned)
        ? Long.fromValue(object.bytes_returned)
        : Long.ZERO,
      cpuTimeMs: isSet(object.cpuTimeMs)
        ? globalThis.Number(object.cpuTimeMs)
        : isSet(object.cpu_time_ms)
        ? globalThis.Number(object.cpu_time_ms)
        : 0,
      memoryUsedBytes: isSet(object.memoryUsedBytes)
        ? Long.fromValue(object.memoryUsedBytes)
        : isSet(object.memory_used_bytes)
        ? Long.fromValue(object.memory_used_bytes)
        : Long.ZERO,
      diskReads: isSet(object.diskReads)
        ? Long.fromValue(object.diskReads)
        : isSet(object.disk_reads)
        ? Long.fromValue(object.disk_reads)
        : Long.ZERO,
      diskWrites: isSet(object.diskWrites)
        ? Long.fromValue(object.diskWrites)
        : isSet(object.disk_writes)
        ? Long.fromValue(object.disk_writes)
        : Long.ZERO,
    };
  },
  ...
  fromJSON(object: any): QueryProgress {
    return {
      ...
      progressPercentage: isSet(object.progressPercentage)
        ? globalThis.Number(object.progressPercentage)
        : isSet(object.progress_percentage)
        ? globalThis.Number(object.progress_percentage)
        : 0,
      ...
      currentPhase: isSet(object.currentPhase)
        ? globalThis.String(object.currentPhase)
        : isSet(object.current_phase)
        ? globalThis.String(object.current_phase)
        : "",
...
export const BatchEditOperation: MessageFns<BatchEditOperation> = {
  encode(message: BatchEditOperation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.whereConditions).forEach(([key, value]: [string, Any]) => {
  ...
  fromJSON(object: any): BatchEditOperation {
    return {
      ...
      whereConditions: isObject(object.whereConditions)
        ? (globalThis.Object.entries(object.whereConditions) as [string, any][]).reduce(
          (acc: { [key: string]: Any }, [key, value]: [string, any]) => {
            acc[key] = Any.fromJSON(value);
            return acc;
          },
        ...
        : isObject(object.where_conditions)
        ? (globalThis.Object.entries(object.where_conditions) as [string, any][]).reduce(
          (acc: { [key: string]: Any }, [key, value]: [string, any]) => {
            acc[key] = Any.fromJSON(value);
            return acc;
          },
  ...
  toJSON(message: BatchEditOperation): unknown {
    ...
    if (message.whereConditions) {
      const entries = globalThis.Object.entries(message.whereConditions) as [string, Any][];
      if (entries.length > 0) {
        obj.whereConditions = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial(object: DeepPartial<BatchEditOperation>): BatchEditOperation {
    ...
    message.whereConditions = (globalThis.Object.entries(object.whereConditions ?? {}) as [string, Any][]).reduce(
      (acc: { [key: string]: Any }, [key, value]: [string, Any]) => {
        if (value !== undefined) {
          acc[key] = Any.fromPartial(value);
        }
  ...
  fromJSON(object: any): ExecuteBatchEditRequest {
    return {
      ...
      operations: globalThis.Array.isArray(object?.operations)
        ...
        : [],
      useTransaction: isSet(object.useTransaction)
        ? globalThis.Boolean(object.useTransaction)
        : isSet(object.use_transaction)
        ? globalThis.Boolean(object.use_transaction)
        : false,
      options: isSet(object.options) ? QueryOptions.fromJSON(object.options) : undefined,
    };
  },
...
export const BatchEditResult: MessageFns<BatchEditResult> = {
  encode(message: BatchEditResult, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.returnedValues).forEach(([key, value]: [string, Any]) => {
  ...
  fromJSON(object: any): BatchEditResult {
    return {
      ...
      returnedValues: isObject(object.returnedValues)
        ? (globalThis.Object.entries(object.returnedValues) as [string, any][]).reduce(
          (acc: { [key: string]: Any }, [key, value]: [string, any]) => {
            acc[key] = Any.fromJSON(value);
            return acc;
          },
        ...
        : isObject(object.returned_values)
        ? (globalThis.Object.entries(object.returned_values) as [string, any][]).reduce(
          (acc: { [key: string]: Any }, [key, value]: [string, any]) => {
            acc[key] = Any.fromJSON(value);
            return acc;
          },
  ...
  toJSON(message: BatchEditResult): unknown {
    ...
    if (message.returnedValues) {
      const entries = globalThis.Object.entries(message.returnedValues) as [string, Any][];
      if (entries.length > 0) {
        obj.returnedValues = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial(object: DeepPartial<BatchEditResult>): BatchEditResult {
    ...
    message.rowsAffected = (object.rowsAffected !== undefined && object.rowsAffected !== null)
      ? Long.fromValue(object.rowsAffected)
      : Long.ZERO;
    message.returnedValues = (globalThis.Object.entries(object.returnedValues ?? {}) as [string, Any][]).reduce(
      (acc: { [key: string]: Any }, [key, value]: [string, Any]) => {
        if (value !== undefined) {
          acc[key] = Any.fromPartial(value);
        }
  ...
  fromJSON(object: any): GetQueryHistoryRequest {
    return {
      ...
      userId: isSet(object.userId)
        ...
        ? globalThis.String(object.user_id)
        : "",
      fromTime: isSet(object.fromTime)
        ? fromJsonTimestamp(object.fromTime)
        : isSet(object.from_time)
        ? fromJsonTimestamp(object.from_time)
        : undefined,
      toTime: isSet(object.toTime)
        ? fromJsonTimestamp(object.toTime)
        : isSet(object.to_time)
        ? fromJsonTimestamp(object.to_time)
        : undefined,
      limit: isSet(object.limit) ? globalThis.Number(object.limit) : 0,
      cursor: isSet(object.cursor) ? globalThis.String(object.cursor) : "",
    };
...
export const ExecutionPlan: MessageFns<ExecutionPlan> = {
  ...
  fromJSON(object: any): ExecutionPlan {
    return {
      ...
      estimatedStats: isSet(object.estimatedStats)
        ? QueryStats.fromJSON(object.estimatedStats)
        : isSet(object.estimated_stats)
        ? QueryStats.fromJSON(object.estimated_stats)
        : undefined,
      actualStats: isSet(object.actualStats)
        ? QueryStats.fromJSON(object.actualStats)
        : isSet(object.actual_stats)
        ? QueryStats.fromJSON(object.actual_stats)
        : undefined,
      warnings: globalThis.Array.isArray(object?.warnings) ? object.warnings.map((e: any) => globalThis.String(e)) : [],
    };
  },
