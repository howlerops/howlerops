  ...
  fromJSON(object: any): SSHTunnelConfig {
    return {
      ...
      authMethod: isSet(object.authMethod)
        ...
        ? sSHAuthMethodFromJSON(object.auth_method)
      ...
      privateKey: isSet(object.privateKey)
        ...
        : "",
      privateKeyPath: isSet(object.privateKeyPath)
        ? globalThis.String(object.privateKeyPath)
        : isSet(object.private_key_path)
        ? globalThis.String(object.private_key_path)
        : "",
      knownHostsPath: isSet(object.knownHostsPath)
        ? globalThis.String(object.knownHostsPath)
        : isSet(object.known_hosts_path)
        ? globalThis.String(object.known_hosts_path)
        : "",
      strictHostKeyChecking: isSet(object.strictHostKeyChecking)
        ? globalThis.Boolean(object.strictHostKeyChecking)
        : isSet(object.strict_host_key_checking)
        ? globalThis.Boolean(object.strict_host_key_checking)
        : false,
      ...
      keepAliveIntervalSeconds: isSet(object.keepAliveIntervalSeconds)
        ...
        : isSet(object.keep_alive_interval_seconds)
        ? globalThis.Number(object.keep_alive_interval_seconds)
        : 0,
    };
  },
...
export const VPCConfig: MessageFns<VPCConfig> = {
  encode(message: VPCConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.customConfig).forEach(([key, value]: [string, string]) => {
  ...
  fromJSON(object: any): VPCConfig {
    return {
      vpcId: isSet(object.vpcId)
        ? globalThis.String(object.vpcId)
        : isSet(object.vpc_id)
        ? globalThis.String(object.vpc_id)
        : "",
      subnetId: isSet(object.subnetId)
        ? globalThis.String(object.subnetId)
        : isSet(object.subnet_id)
        ? globalThis.String(object.subnet_id)
        : "",
      securityGroupIds: globalThis.Array.isArray(object?.securityGroupIds)
        ? object.securityGroupIds.map((e: any) => globalThis.String(e))
        : globalThis.Array.isArray(object?.security_group_ids)
        ? object.security_group_ids.map((e: any) => globalThis.String(e))
        : [],
      privateLinkService: isSet(object.privateLinkService)
        ? globalThis.String(object.privateLinkService)
        : isSet(object.private_link_service)
        ? globalThis.String(object.private_link_service)
        : "",
      endpointServiceName: isSet(object.endpointServiceName)
        ? globalThis.String(object.endpointServiceName)
        : isSet(object.endpoint_service_name)
        ? globalThis.String(object.endpoint_service_name)
        : "",
      customConfig: isObject(object.customConfig)
        ? (globalThis.Object.entries(object.customConfig) as [string, any][]).reduce(
        ...
        : isObject(object.custom_config)
        ? (globalThis.Object.entries(object.custom_config) as [string, any][]).reduce(
          (acc: { [key: string]: string }, [key, value]: [string, any]) => {
            acc[key] = globalThis.String(value);
            return acc;
          },
  ...
  toJSON(message: VPCConfig): unknown {
    ...
    if (message.customConfig) {
      const entries = globalThis.Object.entries(message.customConfig) as [string, string][];
      if (entries.length > 0) {
        obj.customConfig = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial(object: DeepPartial<VPCConfig>): VPCConfig {
    ...
    message.customConfig = (globalThis.Object.entries(object.customConfig ?? {}) as [string, string][]).reduce(
  ...
  fromJSON(object: any): ConnectionConfig {
    return {
      ...
      sslMode: isSet(object.sslMode)
        ? globalThis.String(object.sslMode)
        : isSet(object.ssl_mode)
        ? globalThis.String(object.ssl_mode)
        : "",
      connectionTimeout: isSet(object.connectionTimeout)
        ? globalThis.Number(object.connectionTimeout)
        : isSet(object.connection_timeout)
        ? globalThis.Number(object.connection_timeout)
        : 0,
      ...
      maxConnections: isSet(object.maxConnections)
        ? globalThis.Number(object.maxConnections)
        : isSet(object.max_connections)
        ? globalThis.Number(object.max_connections)
        : 0,
      maxIdleConnections: isSet(object.maxIdleConnections)
        ? globalThis.Number(object.maxIdleConnections)
        : isSet(object.max_idle_connections)
        ? globalThis.Number(object.max_idle_connections)
        : 0,
      parameters: isObject(object.parameters)
        ...
        : {},
      useTunnel: isSet(object.useTunnel)
        ? globalThis.Boolean(object.useTunnel)
        : isSet(object.use_tunnel)
        ? globalThis.Boolean(object.use_tunnel)
        : false,
      sshTunnel: isSet(object.sshTunnel)
        ? SSHTunnelConfig.fromJSON(object.sshTunnel)
        : isSet(object.ssh_tunnel)
        ? SSHTunnelConfig.fromJSON(object.ssh_tunnel)
        : undefined,
      useVpc: isSet(object.useVpc)
        ? globalThis.Boolean(object.useVpc)
        : isSet(object.use_vpc)
        ? globalThis.Boolean(object.use_vpc)
        : false,
      vpcConfig: isSet(object.vpcConfig)
        ? VPCConfig.fromJSON(object.vpcConfig)
        : isSet(object.vpc_config)
        ? VPCConfig.fromJSON(object.vpc_config)
        : undefined,
    };
  },
...
export const TestConnectionResponse: MessageFns<TestConnectionResponse> = {
  encode(message: TestConnectionResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.serverInfo).forEach(([key, value]: [string, string]) => {
  ...
  fromJSON(object: any): TestConnectionResponse {
    return {
      success: isSet(object.success) ? globalThis.Boolean(object.success) : false,
      message: isSet(object.message) ? globalThis.String(object.message) : "",
      responseTimeMs: isSet(object.responseTimeMs)
        ? Long.fromValue(object.responseTimeMs)
        : isSet(object.response_time_ms)
        ? Long.fromValue(object.response_time_ms)
        : Long.ZERO,
      version: isSet(object.version) ? globalThis.String(object.version) : "",
      serverInfo: isObject(object.serverInfo)
        ? (globalThis.Object.entries(object.serverInfo) as [string, any][]).reduce(
          (acc: { [key: string]: string }, [key, value]: [string, any]) => {
            acc[key] = globalThis.String(value);
            return acc;
          },
        ...
        : isObject(object.server_info)
        ? (globalThis.Object.entries(object.server_info) as [string, any][]).reduce(
          (acc: { [key: string]: string }, [key, value]: [string, any]) => {
            acc[key] = globalThis.String(value);
            return acc;
          },
  ...
  toJSON(message: TestConnectionResponse): unknown {
    ...
    if (message.serverInfo) {
      const entries = globalThis.Object.entries(message.serverInfo) as [string, string][];
      if (entries.length > 0) {
        obj.serverInfo = {};
        entries.forEach(([k, v]) => {
          obj.serverInfo[k] = v;
  ...
  fromPartial(object: DeepPartial<TestConnectionResponse>): TestConnectionResponse {
    ...
    message.serverInfo = (globalThis.Object.entries(object.serverInfo ?? {}) as [string, string][]).reduce(
      (acc: { [key: string]: string }, [key, value]: [string, string]) => {
        if (value !== undefined) {
          acc[key] = globalThis.String(value);
        }
  ...
  fromJSON(object: any): GetTablesRequest {
    return {
      ...
      schemaName: isSet(object.schemaName)
        ...
        : "",
      tableType: isSet(object.tableType)
        ? globalThis.String(object.tableType)
        : isSet(object.table_type)
        ? globalThis.String(object.table_type)
        : "",
    };
  },
  ...
  fromJSON(object: any): Table {
    return {
      ...
      rowCount: isSet(object.rowCount)
        ...
        ? Long.fromValue(object.row_count)
        : Long.ZERO,
      sizeBytes: isSet(object.sizeBytes)
        ? Long.fromValue(object.sizeBytes)
        : isSet(object.size_bytes)
  ...
  fromJSON(object: any): Column {
    return {
      ...
      characterMaximumLength: isSet(object.characterMaximumLength)
        ...
        : isSet(object.character_maximum_length)
        ? Long.fromValue(object.character_maximum_length)
        : Long.ZERO,
      numericPrecision: isSet(object.numericPrecision)
        ? globalThis.Number(object.numericPrecision)
        : isSet(object.numeric_precision)
        ? globalThis.Number(object.numeric_precision)
        : 0,
      numericScale: isSet(object.numericScale)
        ? globalThis.Number(object.numericScale)
        : isSet(object.numeric_scale)
        ? globalThis.Number(object.numeric_scale)
        : 0,
      metadata: isObject(object.metadata)
        ? (globalThis.Object.entries(object.metadata) as [string, any][]).reduce(
          (acc: { [key: string]: string }, [key, value]: [string, any]) => {
...
export const TableMetadata: MessageFns<TableMetadata> = {
  encode(message: TableMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.statistics).forEach(([key, value]: [string, string]) => {
  ...
  fromJSON(object: any): TableMetadata {
    return {
      ...
      foreignKeys: globalThis.Array.isArray(object?.foreignKeys)
        ...
        ? object.foreign_keys.map((e: any) => ForeignKey.fromJSON(e))
        : [],
      ...
      statistics: isObject(object.statistics)
        ? (globalThis.Object.entries(object.statistics) as [string, any][]).reduce(
          (acc: { [key: string]: string }, [key, value]: [string, any]) => {
            acc[key] = globalThis.String(value);
            return acc;
          },
  ...
  toJSON(message: TableMetadata): unknown {
    ...
    if (message.statistics) {
      const entries = globalThis.Object.entries(message.statistics) as [string, string][];
      if (entries.length > 0) {
        obj.statistics = {};
        entries.forEach(([k, v]) => {
          obj.statistics[k] = v;
  ...
  fromPartial(object: DeepPartial<TableMetadata>): TableMetadata {
    ...
    message.statistics = (globalThis.Object.entries(object.statistics ?? {}) as [string, string][]).reduce(
      (acc: { [key: string]: string }, [key, value]: [string, string]) => {
        if (value !== undefined) {
          acc[key] = globalThis.String(value);
        }
...
export const ConnectionHealthResponse: MessageFns<ConnectionHealthResponse> = {
  encode(message: ConnectionHealthResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.metrics).forEach(([key, value]: [string, string]) => {
  ...
  fromJSON(object: any): ConnectionHealthResponse {
    return {
      ...
      activeConnections: isSet(object.activeConnections)
        ...
        : 0,
      idleConnections: isSet(object.idleConnections)
        ? globalThis.Number(object.idleConnections)
        : isSet(object.idle_connections)
        ? globalThis.Number(object.idle_connections)
        : 0,
  ...
  toJSON(message: ConnectionHealthResponse): unknown {
    ...
    if (message.metrics) {
      const entries = globalThis.Object.entries(message.metrics) as [string, string][];
      if (entries.length > 0) {
        obj.metrics = {};
        entries.forEach(([k, v]) => {
          obj.metrics[k] = v;
  ...
  fromPartial(object: DeepPartial<ConnectionHealthResponse>): ConnectionHealthResponse {
    ...
    message.metrics = (globalThis.Object.entries(object.metrics ?? {}) as [string, string][]).reduce(
      (acc: { [key: string]: string }, [key, value]: [string, string]) => {
        if (value !== undefined) {
          acc[key] = globalThis.String(value);
        }
