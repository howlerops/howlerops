...
export const SubscribeRequest: MessageFns<SubscribeRequest> = {
  encode(message: SubscribeRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    writer.join();
    globalThis.Object.entries(message.filters).forEach(([key, value]: [string, string]) => {
  ...
  toJSON(message: SubscribeRequest): unknown {
    ...
    if (message.filters) {
      const entries = globalThis.Object.entries(message.filters) as [string, string][];
      if (entries.length > 0) {
        obj.filters = {};
        entries.forEach(([k, v]) => {
          obj.filters[k] = v;
  ...
  fromPartial(object: DeepPartial<SubscribeRequest>): SubscribeRequest {
    ...
    message.filters = (globalThis.Object.entries(object.filters ?? {}) as [string, string][]).reduce(
  ...
  fromJSON(object: any): QueryErrorEvent {
    return {
      ...
      errorCode: isSet(object.errorCode)
        ...
        : "",
      sqlState: isSet(object.sqlState)
        ? globalThis.String(object.sqlState)
        : isSet(object.sql_state)
        ? globalThis.String(object.sql_state)
        : "",
      timestamp: isSet(object.timestamp) ? fromJsonTimestamp(object.timestamp) : undefined,
    };
  },
  ...
  fromJSON(object: any): RealtimeEvent {
    return {
      ...
      eventId: isSet(object.eventId)
        ...
        : "",
      timestamp: isSet(object.timestamp) ? fromJsonTimestamp(object.timestamp) : undefined,
      queryProgress: isSet(object.queryProgress)
        ? QueryProgressEvent.fromJSON(object.queryProgress)
        : isSet(object.query_progress)
        ? QueryProgressEvent.fromJSON(object.query_progress)
        : undefined,
      queryResult: isSet(object.queryResult)
        ? QueryResultEvent.fromJSON(object.queryResult)
        : isSet(object.query_result)
        ? QueryResultEvent.fromJSON(object.query_result)
        : undefined,
      queryError: isSet(object.queryError)
        ? QueryErrorEvent.fromJSON(object.queryError)
        : isSet(object.query_error)
        ? QueryErrorEvent.fromJSON(object.query_error)
        : undefined,
      connectionStatus: isSet(object.connectionStatus)
        ? ConnectionStatusEvent.fromJSON(object.connectionStatus)
        : isSet(object.connection_status)
        ? ConnectionStatusEvent.fromJSON(object.connection_status)
        : undefined,
      tableChanged: isSet(object.tableChanged)
        ? TableChangedEvent.fromJSON(object.tableChanged)
        : isSet(object.table_changed)
        ? TableChangedEvent.fromJSON(object.table_changed)
        : undefined,
      schemaChanged: isSet(object.schemaChanged)
        ? SchemaChangedEvent.fromJSON(object.schemaChanged)
        : isSet(object.schema_changed)
        ? SchemaChangedEvent.fromJSON(object.schema_changed)
        : undefined,
      userAction: isSet(object.userAction)
        ? UserActionEvent.fromJSON(object.userAction)
        : isSet(object.user_action)
        ? UserActionEvent.fromJSON(object.user_action)
        : undefined,
      systemAlert: isSet(object.systemAlert)
        ? SystemAlertEvent.fromJSON(object.systemAlert)
        : isSet(object.system_alert)
        ? SystemAlertEvent.fromJSON(object.system_alert)
        : undefined,
  ...
  fromJSON(object: any): PublishEventRequest {
    return {
      ...
      targetClients: globalThis.Array.isArray(object?.targetClients)
        ...
        : globalThis.Array.isArray(object?.target_clients)
        ? object.target_clients.map((e: any) => globalThis.String(e))
        : [],
      filters: isObject(object.filters)
        ? (globalThis.Object.entries(object.filters) as [string, any][]).reduce(
          (acc: { [key: string]: string }, [key, value]: [string, any]) => {
...
export const PublishEventResponse: MessageFns<PublishEventResponse> = {
  ...
  fromJSON(object: any): PublishEventResponse {
    return {
      success: isSet(object.success) ? globalThis.Boolean(object.success) : false,
      message: isSet(object.message) ? globalThis.String(object.message) : "",
      clientsNotified: isSet(object.clientsNotified)
        ? globalThis.Number(object.clientsNotified)
        : isSet(object.clients_notified)
        ? globalThis.Number(object.clients_notified)
        : 0,
    };
  },
  ...
  fromJSON(object: any): ActiveSubscription {
    return {
      ...
      filters: isObject(object.filters)
        ...
        : {},
      subscribedAt: isSet(object.subscribedAt)
        ? fromJsonTimestamp(object.subscribedAt)
        : isSet(object.subscribed_at)
        ? fromJsonTimestamp(object.subscribed_at)
        : undefined,
  ...
  fromJSON(object: any): GetActiveSubscriptionsResponse {
    return {
      ...
      subscriptions: globalThis.Array.isArray(object?.subscriptions)
        ...
        : [],
      totalClients: isSet(object.totalClients)
        ? globalThis.Number(object.totalClients)
        : isSet(object.total_clients)
        ? globalThis.Number(object.total_clients)
        : 0,
    };
  },
