...
export function AssignTableSteward(arg1:string,arg2:string):Promise<void>;
...
export function CompareConnectionSchemas(arg1:string,arg2:string):Promise<schemadiff.SchemaDiff>;

export function CompareWithSnapshot(arg1:string,arg2:string):Promise<schemadiff.SchemaDiff>;
...
export function CreateCatalogTag(arg1:catalog.CatalogTag):Promise<void>;

export function CreateColumnCatalogEntry(arg1:catalog.ColumnCatalogEntry):Promise<void>;
...
export function CreateSchemaSnapshot(arg1:string,arg2:string):Promise<schemadiff.SnapshotMetadata>;

export function CreateTableCatalogEntry(arg1:catalog.TableCatalogEntry):Promise<void>;
...
export function DeleteCatalogTag(arg1:string):Promise<void>;
...
export function DeleteSchemaSnapshot(arg1:string):Promise<void>;

export function DeleteSyntheticView(arg1:string):Promise<void>;

export function DeleteTableCatalogEntry(arg1:string):Promise<void>;
...
export function GenerateMigrationSQL(arg1:string,arg2:string,arg3:boolean):Promise<schemadiff.MigrationScript>;

export function GenerateMigrationSQLFromSnapshot(arg1:string,arg2:string,arg3:boolean):Promise<schemadiff.MigrationScript>;
...
export function GetCatalogStats(arg1:string):Promise<main.CatalogStats>;

export function GetColumnCatalogEntry(arg1:string,arg2:string):Promise<catalog.ColumnCatalogEntry>;
...
export function GetSchemaSnapshot(arg1:string):Promise<schemadiff.SchemaSnapshot>;
...
export function GetTableCatalogEntry(arg1:string,arg2:string,arg3:string):Promise<catalog.TableCatalogEntry>;
...
export function ListCatalogTags(arg1:any):Promise<Array<catalog.CatalogTag>>;

export function ListColumnCatalogEntries(arg1:string):Promise<Array<catalog.ColumnCatalogEntry>>;
...
export function ListSchemaSnapshots():Promise<Array<schemadiff.SnapshotMetadata>>;

export function ListSyntheticViews():Promise<Array<main.SyntheticViewSummary>>;

export function ListTableCatalogEntries(arg1:string):Promise<Array<catalog.TableCatalogEntry>>;
...
export function MarkColumnAsPII(arg1:string,arg2:string,arg3:string,arg4:number):Promise<void>;
...
export function SearchCatalog(arg1:string,arg2:catalog.SearchFilters):Promise<catalog.SearchResults>;
...
export function SyncCatalogFromConnection(arg1:string):Promise<main.CatalogSyncResult>;
...
export function UpdateColumnCatalogEntry(arg1:catalog.ColumnCatalogEntry):Promise<void>;

export function UpdateQueryRow(arg1:main.QueryRowUpdateRequest):Promise<main.QueryRowUpdateResponse>;

export function UpdateTableCatalogEntry(arg1:catalog.TableCatalogEntry):Promise<void>;
