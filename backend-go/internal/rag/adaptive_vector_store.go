...
func (a *AdaptiveVectorStore) Initialize(ctx context.Context) error {
	return a.localStore.Initialize(ctx)
}
...
func (a *AdaptiveVectorStore) ListCollections(ctx context.Context) ([]string, error) {
	return a.localStore.ListCollections(ctx)
}
...
func (a *AdaptiveVectorStore) Backup(ctx context.Context, path string) error {
	return a.localStore.Backup(ctx, path)
}
func (a *AdaptiveVectorStore) Restore(ctx context.Context, path string) error {
	return a.localStore.Restore(ctx, path)
}
